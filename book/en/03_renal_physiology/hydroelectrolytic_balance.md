...
```{figure} _static/generated/hydroelectrolytic_balance/page4_img1_final.png
:alt: Diagram extracted from notes — right upper columns included
:width: 80%
:align: center
:name: fig-hydroel-page4
---
cerebrospinal fluid and the fluid of serous spaces such as pleural, peritoneal, and pericardial spaces; are enclosed inside the intracellular fluid compartment (ICF). These compartments are separated by membranes: they separate the intracellular from the interstitial.
```
...
### Regulation of Eliminated Volume
